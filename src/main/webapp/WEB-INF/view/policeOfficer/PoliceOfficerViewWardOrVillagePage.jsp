                ...
                <ul class="nav navbar-nav">
                  <li>
                    ...
                    <li class="menu-item-has-children dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-table"></i>Criminal Records</a>
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="fa fa-table"></i><a href="/ResidentManagementSystem/policeOfficer/viewMaleCriminalRecordList/${policeOfficer.policeOfficerId}">Male</a></li>
                            <li><i class="fa fa-table"></i><a href="/ResidentManagementSystem/policeOfficer/viewFemaleCriminalRecordList/${policeOfficer.policeOfficerId}">Female</a></li>
                            <li><i class="fa fa-table"></i><a href="/ResidentManagementSystem/policeOfficer/manageCriminalRecordList/${policeOfficer.policeOfficerId}">All</a></li>
                        </ul>
                    </li>
                </ul>
            </div><!-- /.navbar-collapse -->
                  ...
                  <div class="col-md-12">
                    <div class="card" >
                            <div class="card-header" style="text-align:center; background-color:#3A4D6F; color:#fff;">
                                <strong class="card-title">Wards and Villages of Myanmar</strong>
                            </div>
                            <div class="card-body">
                             <%@taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c"%>
                                <table id="bootstrap-data-table" class="table table-striped table-bordered" style="text-align:center;">
                                    <thead>
										<tr><th>No.</th>
											<th>Ward or Village Name</th>
											<th>Township Name</th>
										</tr>
									</thead>
									<tbody>
                          
									     <c:forEach var="wardorvillage" items="${wardOrVillageList}" varStatus = "wardOrVillageCount">
										<tr><td><c:out value ="${wardOrVillageCount.count}"/></td>
										<td><c:out value ="${wardorvillage.wardOrVillageName}"/></td>
										<td><c:out value ="${wardorvillage.township.townshipName}"/></td>
										 </tr>
