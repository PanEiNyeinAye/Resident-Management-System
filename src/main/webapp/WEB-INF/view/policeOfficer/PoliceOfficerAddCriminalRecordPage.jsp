                ...
                <div class="row">
                     <div class="card" style="left:190px;">
                            <div class="card-header" style="color:#fff; text-align:center;background-color:#3A4D6F;">
                               <strong>	Add Criminal Record </strong>
                            </div>
                            <div class="card-body card-block">
           <form:form method="post" action="/ResidentManagementSystem/policeOfficer/addCriminalRecord/${policeOfficer.policeOfficerId}" modelAttribute="crime">
							...
							<form:radiobutton path="resultOfTheTrial" value="1" id="inline-radio1" name="inline-radios" class="form-check-input" required="true"/>Still Facing The Trial<br>
							 </label>&nbsp;
