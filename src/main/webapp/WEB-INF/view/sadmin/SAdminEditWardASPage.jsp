 ...
 <aside id="left-panel" class="left-panel">
    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="content">
           ...
           <form:form method="post" action="/ResidentManagementSystem/sadmin/editWardAS/${sadmin.sadminId}">
							...
							<a href="/ResidentManagementSystem/sadmin/manageWardASList/${sadmin.sadminId}" style="display:inline-block;color:white;float:left;"><i class="fa fa-angle-double-left" style="font-size:28px;" aria-hidden="true"></i></a><input type="Submit">
							</div>
				</form:form>
           </div>
            </div>
