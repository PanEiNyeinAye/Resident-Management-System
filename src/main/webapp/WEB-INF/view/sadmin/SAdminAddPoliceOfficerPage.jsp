                ...
                <div class="row">
                  <div class="card" style="left:190px;">
                            <div class="card-header" style="color:#fff; text-align:center;background-color:#3A4D6F;">
                               <strong>	Add Police Officer </strong>
                            </div>
                            <div class="card-body card-block">
           <form:form method="post" action="/ResidentManagementSystem/sadmin/addPoliceOfficer/${sadmin.sadminId}" modelAttribute="policeOfficer">
           					<div class="row form-group">
		                    <div class="col col-md-3"><label for="text-input" class=" form-control-label">Name</label></div>
		                    <div class="col-12 col-md-9"><form:input path="policeOfficerName" id="text-input" name="text-input"  class="form-control" required="true"/><small class="form-text text-muted">Please use U/Daw before the name!</small></div>
		                	</div>
	
							<div class="row form-group">
		                    <div class="col col-md-3"><label for="text-input" class=" form-control-label">Employee No.</label></div>
		                    <div class="col-12 col-md-9"><form:input path="policeEmployeeNo" id="text-input" name="text-input"  class="form-control" placeholder="" required="true"/><small class="form-text text-muted"></small></div>
		                	</div>
							
							<div class="row form-group">
		                    <div class="col col-md-3"><label for="text-input" class=" form-control-label">Position</label></div>
		                    <div class="col-12 col-md-9"><form:input path="policeOfficerPosition" id="text-input" name="text-input"  class="form-control" placeholder="" required="true"/><small class="form-text text-muted"></small></div>
		                	</div>
		                	
							<div class="row form-group">
							<div class="col col-md-3"><label for="email-input" class=" form-control-label">Email</label></div>
							<div class="col-12 col-md-9"><form:input path="policeOfficerEmail" placeholder="Enter Email" id="email-input" name="email-input" class="form-control" required="true"/><small class="help-block form-text">Please enter your email</small></div><br>
							<div class="col-12 col-md-9 error"><c:if test="${error eq true}">* Email must be in correct format.</c:if></div>
							</div>
							
							<div class="row form-group">
		                    <div class="col col-md-3"><label for="text-input" class=" form-control-label">Password</label></div>
		                    <div class="col-12 col-md-9"><form:password path="policeOfficerPassword" id="text-input" name="text-input"  class="form-control" required="true"/><small class="form-text text-muted"></small></div>
		                	<div class="col-12 col-md-9 error"><c:if test="${error eq true}">* Password must have 8 characters.</c:if></div>
		                	</div>
							
							<div class="row form-group">
		                    <div class="col col-md-3"><label for="text-input" class=" form-control-label">Township Name</label></div>
		                    <div class="col-12 col-md-9">
			                    <form:select path="townshipId" name="select" id="select" class="form-control">
			                    	<c:forEach var="township" items="${townshipList}">
			                    	<form:option value="${township.townshipId}" label="${township.townshipName}"/>
			                    	</c:forEach>
			                    </form:select>
		                    </div>
		                	</div>
							...
							<a href="/ResidentManagementSystem/sadmin/managePoliceOfficerList/${sadmin.sadminId}" style="display:inline-block;color:white;float:left;"><i class="fa fa-angle-double-left" style="font-size:28px;" aria-hidden="true"></i></a><input type="Submit">
							</div>
				</form:form>
           </div>
            </div>
