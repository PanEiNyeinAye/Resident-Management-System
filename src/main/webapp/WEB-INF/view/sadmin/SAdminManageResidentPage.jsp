...
<head>
    ...
    <title>Sub Admin Manage Residents</title>
        ...
        <div class="content">
            <div class="animated fadeIn">
                <div class="row">
                        ...
                        <div class="card" >
                            <div class="card-header" style="text-align:right; background-color:#3A4D6F; color:#fff;">
                            	<div style="text-align:center;position:relative;"><Strong>Residents of ${sadmin.stateOrRegion.stateOrRegionName}</Strong></div>
         						<a href="/ResidentManagementSystem/sadmin/getAddResident/${sadmin.sadminId}" style="color:#fff"><i class="material-icons" style="color:#fff">&#xE147;</i> Add New Resident</a>
                            </div>
                            <div class="card-body">
                             <%@taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c"%>
               ...
               <thead>
                ...
                <tbody>
                 <c:forEach var="resident" items="${residentListBySAdmin}" varStatus="residentCount">
                    <tr>
						...
						<td>
                            <a href="/ResidentManagementSystem/sadmin/getEditResident/${resident.residentId}/${sadmin.sadminId}" class="fa fa-pencil-square-o" aria-hidden="true"></a>
                        </td>				
					</tr>	
					 </c:forEach>				
                </tbody>
