                ...
                <div class="row">
                     <div class="card">
                             <div class="card-header" style="text-align:right; background-color:#3A4D6F; color:#fff;">
                            	<div style="text-align:center;position:relative;"><Strong>Birth Certificate Registration (${sadmin.stateOrRegion.stateOrRegionName})</Strong></div>
         						<a href="/ResidentManagementSystem/sadmin/getAddBirth/${sadmin.sadminId}" style="color:#fff"><i class="material-icons" style="color:#fff">&#xE147;</i> Add New Birth Certificate Registration</a>
                            </div>
                            <div class="card-body">
                             <%@taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c"%>
                ...
                <tbody>
                 <c:forEach var="baby" items="${birthList}" varStatus="babyCount">
                    <tr>
						...
						<td>
                            <a href="/ResidentManagementSystem/sadmin/getEditBirth/${baby.birthId}/${sadmin.sadminId}" class="fa fa-pencil-square-o" aria-hidden="true"></a>
                        </td>	
					</tr>	
					 </c:forEach>				
                </tbody>
