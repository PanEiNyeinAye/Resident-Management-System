    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="content">
                ...
                <div class="row">
                     <div class="card">
                            <div class="card-header" style="text-align:right; background-color:#3A4D6F; color:#fff;">
                            	<div style="text-align:center;position:relative;"><Strong>General Administrative Staffs of ${sadmin.stateOrRegion.stateOrRegionName}</Strong></div>
         						<a href="/ResidentManagementSystem/sadmin/getAddGAS/${sadmin.sadminId}" style="color:#fff"><i class="material-icons" style="color:#fff">&#xE147;</i> Add New General Administrative Staff</a>
                            </div>
                            <div class="card-body">
            ...
            <table id="bootstrap-data-table" class="table table-striped table-bordered" style="text-align:center;">
                ...
                <tbody>
                 <c:forEach var="gas" items="${gasListBySAdmin}" varStatus="gasCount">
                    <tr>
                    	<td><c:out value ="${gasCount.count}"/></td>
                    	<td><c:out value ="${gas.gasName}"/></td>
                    	<td><c:out value ="${gas.gasEmployeeNo}"/></td>
                    	<td><c:out value ="${gas.gasPosition}"/></td>
						<td><c:out value ="${gas.gasEmail}"/></td>
						<td><c:out value ="${gas.gasPassword}"/></td>
						<td><c:out value ="${gas.township.townshipName}"/></td>
						<td>
                            <a href="/ResidentManagementSystem/sadmin/getEditGAS/${gas.gasId}/${sadmin.sadminId}" class="fa fa-pencil-square-o" aria-hidden="true"></a>
                        </td>				
					</tr>	
					 </c:forEach>				
                </tbody>
