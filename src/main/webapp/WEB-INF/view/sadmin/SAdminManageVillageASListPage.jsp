            ...
            <div class="animated fadeIn">
                ...
                <div class="row">
                             ...
                             <div class="card-header" style="text-align:right; background-color:#3A4D6F; color:#fff;">
                            	<div style="text-align:center;position:relative;"><Strong>Village Administrators of ${sadmin.stateOrRegion.stateOrRegionName}</Strong></div>
         						<a href="/ResidentManagementSystem/sadmin/getAddVillageAS/${sadmin.sadminId}" style="color:#fff"><i class="material-icons" style="color:#fff">&#xE147;</i> Add New Village Administrator</a>
                            </div>
                            <div class="card-body">
                             <%@taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c"%>
                ...
                <tbody>
                 <c:forEach var="wardas" items="${villageASListBySAdmin}" varStatus="wardasCount">
                    <tr>
						...
						<td>
                            <a href="/ResidentManagementSystem/sadmin/getEditVillageAS/${wardas.wardASId}/${sadmin.sadminId}" class="fa fa-pencil-square-o" aria-hidden="true"></a>
                        </td>						
					</tr>	
					 </c:forEach>				
                </tbody>
