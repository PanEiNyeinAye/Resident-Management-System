    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="content">
                ...
                <div class="row">
                     <div class="card">
                            <div class="card-header" style="text-align:right; background-color:#3A4D6F; color:#fff;">
                            	<div style="text-align:center;position:relative;"><Strong>Police Officers of ${sadmin.stateOrRegion.stateOrRegionName}</Strong></div>
         						<a href="/ResidentManagementSystem/sadmin/getAddPoliceOfficer/${sadmin.sadminId}" style="color:#fff"><i class="material-icons" style="color:#fff">&#xE147;</i> Add New Police Officer</a>
                            </div>
                            <div class="card-body">
            ...
            <table id="bootstrap-data-table" class="table table-striped table-bordered" style="text-align:center;">
                ...
                <tbody>
                 <c:forEach var="policeOfficer" items="${policeOfficerListBySAdmin}" varStatus="policeOfficerCount">
                    <tr>
                    	<td><c:out value ="${policeOfficerCount.count}"/></td>
                    	<td><c:out value ="${policeOfficer.policeOfficerName}"/></td>
                    	<td><c:out value ="${policeOfficer.policeEmployeeNo}"/></td>
                    	<td><c:out value ="${policeOfficer.policeOfficerPosition}"/></td>
						<td><c:out value ="${policeOfficer.policeOfficerEmail}"/></td>
						<td><c:out value ="${policeOfficer.policeOfficerPassword}"/></td>
						<td><c:out value ="${policeOfficer.township.townshipName}"/></td>
						<td>
                            <a href="/ResidentManagementSystem/sadmin/getEditPoliceOfficer/${policeOfficer.policeOfficerId}/${sadmin.sadminId}" class="fa fa-pencil-square-o" aria-hidden="true"></a>
                        </td>				
					</tr>	
					 </c:forEach>				
                </tbody>
