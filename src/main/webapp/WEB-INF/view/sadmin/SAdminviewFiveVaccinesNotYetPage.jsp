...
<head>
    ...
    <title>Sub Admin View Vaccination Status</title>
                ...
                <div class="row">
                        ...
                        <div class="card" >
                           <div class="card-header" style="text-align:center; background-color:#3A4D6F; color:#fff;">
                                <strong class="card-title">Five Vaccines not vaccinated yet Residents (${sadmin.stateOrRegion.stateOrRegionName})</strong>
                            </div>
                            <div class="card-body">
                             <%@taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c"%>
