                ...
                <div class="row">
                  <div class="card" style="left:190px;">
                            <div class="card-header" style="color:#fff; text-align:center;background-color:#3A4D6F;">
                               <strong>	Add General Administrative Staff </strong>
                            </div>
                            <div class="card-body card-block">
           <form:form method="post" action="/ResidentManagementSystem/sadmin/addGAS/${sadmin.sadminId}" modelAttribute="gas">
           					<div class="row form-group">
		                    <div class="col col-md-3"><label for="text-input" class=" form-control-label">Name</label></div>
		                    <div class="col-12 col-md-9"><form:input path="gasName" id="text-input" name="text-input"  class="form-control" required="true"/><small class="form-text text-muted">Please use U/Daw before the name!</small></div>
		                	</div>
	
							<div class="row form-group">
		                    <div class="col col-md-3"><label for="text-input" class=" form-control-label">Employee No.</label></div>
		                    <div class="col-12 col-md-9"><form:input path="gasEmployeeNo" id="text-input" name="text-input"  class="form-control" placeholder="" required="true"/><small class="form-text text-muted"></small></div>
		                	</div>
							
							<div class="row form-group">
		                    <div class="col col-md-3"><label for="text-input" class=" form-control-label">Position</label></div>
		                    <div class="col-12 col-md-9"><form:input path="gasPosition" id="text-input" name="text-input"  class="form-control" placeholder="" required="true"/><small class="form-text text-muted"></small></div>
		                	</div>
		                	
							<div class="row form-group">
							<div class="col col-md-3"><label for="email-input" class=" form-control-label">Email</label></div>
							<div class="col-12 col-md-9"><form:input path="gasEmail" placeholder="Enter Email" id="email-input" name="email-input" class="form-control" required="true"/><small class="help-block form-text">Please enter your email</small></div><br>
							<div class="col-12 col-md-9 error"><c:if test="${error eq true}">* Email must be in correct format.</c:if></div>
							</div>
							
							<div class="row form-group">
		                    <div class="col col-md-3"><label for="text-input" class=" form-control-label">Password</label></div>
		                    <div class="col-12 col-md-9"><form:password path="gasPassword" id="text-input" name="text-input"  class="form-control" required="true"/><small class="form-text text-muted"></small></div>
							...
							<a href="/ResidentManagementSystem/sadmin/manageGASList/${sadmin.sadminId}" style="display:inline-block;color:white;float:left;"><i class="fa fa-angle-double-left" style="font-size:28px;" aria-hidden="true"></i></a><input type="Submit">
							</div>
				</form:form>
           </div>
            </div>
