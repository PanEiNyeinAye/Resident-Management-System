...
<head>
    ...
    <title>Sub Admin View Over 10 Non NRC Residents</title>
 ...
 <aside id="left-panel" class="left-panel">
    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="content">
                ...
                <div class="row">
                        ...
                        <div class="card" >
                          <div class="card-header" style="text-align:center; background-color:#3A4D6F; color:#fff;">
                                <strong class="card-title">Residents 10 years or over 10 years old who lost NRC or have not registered yet (Female) (${sadmin.stateOrRegion.stateOrRegionName})</strong>
                            </div>
                            <div class="card-body">
                             <%@taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c"%>
            ...
            <a href="/ResidentManagementSystem/sadmin/viewOver10NonNRC/${sadmin.sadminId}" style="display:inline-block;color:#3A4D6F;float:left;"><i class="fa fa-angle-double-left" style="font-size:28px;" aria-hidden="true"></i></a>
                            </div>
                        </div>
                    </div>
