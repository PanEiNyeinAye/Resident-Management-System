...
<head>
    ...
    <title>GAS Manage Village Administrator</title>
                ...
                <div class="row">
                  <div class="card" style="left:190px;">
                            <div class="card-header" style="color:#fff; text-align:center;background-color:#3A4D6F;">
                               <strong>	Edit Village Administrator </strong>
                            </div>
                            <div class="card-body card-block">
           <form:form method="post" action="/ResidentManagementSystem/gas/editVillageAS/${gas.gasId}">
							...
							<a href="/ResidentManagementSystem/gas/manageVillageASList/${gas.gasId}" style="display:inline-block;color:white;float:left;"><i class="fa fa-angle-double-left" style="font-size:28px;" aria-hidden="true"></i></a><input type="Submit">
							</div>
				</form:form>
           </div>
            </div>
