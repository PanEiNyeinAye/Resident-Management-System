...
<head>
    ...
    <title>GAS View Below 10 Non NRC Residents</title>
   ...
   <!-- Left Panel -->
    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="content">
                ...
                <div class="row">
                        ...
                        <div class="card" >
                           <div class="card-header" style="text-align:center; background-color:#3A4D6F; color:#fff;">
                                <strong class="card-title">Residents below 10 years old who can't register yet(Female) (${gas.township.townshipName})</strong>
                            </div>
                            <div class="card-body">
                             <%@taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c"%>
            ...
            <a href="/ResidentManagementSystem/gas/viewBelow10NonNRC/${gas.gasId}" style="display:inline-block;color:#3A4D6F;float:left;"><i class="fa fa-angle-double-left" style="font-size:28px;" aria-hidden="true"></i></a>
                            </div>
                        </div>
                    </div>
