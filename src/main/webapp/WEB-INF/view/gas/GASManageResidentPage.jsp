        ...
        <div class="content">
            <div class="animated fadeIn">
                <div class="row">
                        ...
                        <div class="card" >
                            <div class="card-header" style="text-align:right; background-color:#3A4D6F; color:#fff;">
                            	<div style="text-align:center;position:relative;"><Strong>Residents of ${gas.township.townshipName}</Strong></div>
         						<a href="/ResidentManagementSystem/gas/getAddResident/${gas.gasId}" style="color:#fff"><i class="material-icons" style="color:#fff">&#xE147;</i> Add New Resident</a>
                            </div>
                            <div class="card-body">
                             <%@taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c"%>
               ...
               <thead>
                ...
                <tbody>
                 <c:forEach var="resident" items="${residentList}" varStatus="residentCount">
                    <tr>
						...
						<td>
                            <a href="/ResidentManagementSystem/gas/getEditResident/${resident.residentId}/${gas.gasId}" class="fa fa-pencil-square-o" aria-hidden="true"></a>
                        </td>				
					</tr>	
					 </c:forEach>				
                </tbody>
