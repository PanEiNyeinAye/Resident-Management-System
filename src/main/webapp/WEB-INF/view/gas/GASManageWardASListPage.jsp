...
<head>
    ...
    <title>GAS Manage Ward Administrators</title>
            ...
            <div class="animated fadeIn">
                ...
                <div class="row">
                             ...
                             <div class="card-header" style="text-align:right; background-color:#3A4D6F; color:#fff;">
                            	<div style="text-align:center;position:relative;"><Strong>Ward Administrators of ${gas.township.townshipName}</Strong></div>
         						<a href="/ResidentManagementSystem/gas/getAddWardAS/${gas.gasId}" style="color:#fff"><i class="material-icons" style="color:#fff">&#xE147;</i> Add New Ward Administrator</a>
                            </div>
                            <div class="card-body">
                             <%@taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c"%>
                ...
                <tbody>
                 <c:forEach var="wardas" items="${wardASList}" varStatus="wardasCount">
                    <tr>
						...
						<td>
                            <a href="/ResidentManagementSystem/gas/getEditWardAS/${wardas.wardASId}/${gas.gasId}" class="fa fa-pencil-square-o" aria-hidden="true"></a>
                        </td>				
					</tr>	
					 </c:forEach>				
                </tbody>
