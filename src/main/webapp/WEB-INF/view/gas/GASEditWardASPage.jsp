...
<head>
    ...
    <title>GAS Manage Ward Administrator</title>
   ...
   <!-- Left Panel -->
    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="content">
           ...
           <form:form method="post" action="/ResidentManagementSystem/gas/editWardAS/${gas.gasId}">
           					
           					<form:hidden path="wardASId"/>
           					
           					<div class="row form-group">
		                    <div class="col col-md-3"><label for="text-input" class=" form-control-label">Name</label></div>
		                    <div class="col-12 col-md-9"><form:input path="wardASName" id="text-input" name="text-input"  class="form-control" required="true"/></div>
		                	</div>
							...
							<a href="/ResidentManagementSystem/gas/manageWardASList/${gas.gasId}" style="display:inline-block;color:white;float:left;"><i class="fa fa-angle-double-left" style="font-size:28px;" aria-hidden="true"></i></a><input type="Submit">
							</div>
				</form:form>
           </div>
            </div>
