...
<head>
    ...
    <title>GAS Manage Residents</title>
   ...
   <!-- Left Panel -->
    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="content">
           ...
           <form:form method="post" action="/ResidentManagementSystem/gas/addResident/${gas.gasId}" modelAttribute="resident">
           
           					<div class="row form-group">
		                    <div class="col col-md-3"><label for="text-input" class=" form-control-label">Name</label></div>
		                    <div class="col-12 col-md-9"><form:input path="residentName" id="text-input" name="text-input"  class="form-control" required="true"/><small class="form-text text-muted">Please don't use U/Daw/Ko/Mg/Ma before the name!</small></div>
		                	</div>
		                    ...
		                    <div class="col-12 col-md-9"><form:input path="dob" id="text-input" name="text-input"  class="form-control" type="date" required="true"/><small class="form-text text-muted">Please choose the birth date of resident correctly!</small></div>
		                	</div>
	
							<div class="row form-group">
		                    <div class="col col-md-3"><label for="text-input" class=" form-control-label">National Registration Card(NRC) No.</label></div>
		                    <div class="col-12 col-md-9"><form:input path="nrcNo" id="text-input" name="text-input"  class="form-control" placeholder="Eg; 8/MaLaNa(N)000000" required="true"/><small class="form-text text-muted">Please write in the correct order!</small></div>
		                    ...
		                    <div class="col-12 col-md-9"><form:input path="fatherName" id="text-input" name="text-input"  class="form-control" required="true"/><small class="form-text text-muted">Please don't use U/Daw/Ko/Mg/Ma before the name!</small></div>
		                	</div>
					
							<div class="row form-group">
		                    <div class="col col-md-3"><label for="text-input" class=" form-control-label">Mother's Name</label></div>
		                    <div class="col-12 col-md-9"><form:input path="motherName" id="text-input" name="text-input"  class="form-control" required="true"/><small class="form-text text-muted">Please don't use U/Daw/Ko/Mg/Ma before the name!</small></div>
		                	</div>
							...
							<div class="col-12 col-md-9"><form:input path="residentEmail" placeholder="Enter Email" id="email-input" name="email-input" class="form-control" required="true"/><small class="help-block form-text">Please enter your email</small></div><br>
						...
						<div class="row form-group">
							...
							<a href="/ResidentManagementSystem/gas/manageResidentList/${gas.gasId}" style="display:inline-block;color:white;float:left;"><i class="fa fa-angle-double-left" style="font-size:28px;" aria-hidden="true"></i></a><input type="Submit">
							</div>
				</form:form>
           </div>
            </div>
