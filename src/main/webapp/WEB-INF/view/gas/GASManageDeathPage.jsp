                ...
                <div class="row">
                     <div class="card">
                            <div class="card-header" style="text-align:right; background-color:#3A4D6F; color:#fff;">
                            	<div style="text-align:center;position:relative;"><Strong>Death Registration (${gas.township.townshipName})</Strong></div>
         						<a href="/ResidentManagementSystem/gas/getAddDeath/${gas.gasId}" style="color:#fff"><i class="material-icons" style="color:#fff">&#xE147;</i> Add New Death Registration</a>
                            </div>
                            <div class="card-body">
                             <%@taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c"%>
                ...
                <tbody>
                 <c:forEach var="deceased" items="${deathList}" varStatus="deceasedCount">
                    <tr>
						...
						<td>
                            <a href="/ResidentManagementSystem/gas/getEditDeath/${deceased.deathId}/${gas.gasId}" class="fa fa-pencil-square-o" aria-hidden="true"></a>
                        </td>			
					</tr>	
					 </c:forEach>				
                </tbody>
