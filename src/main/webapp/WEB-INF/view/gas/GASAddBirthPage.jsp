...
<head>
    ...
    <title>GAS Manage Birth Registration</title>
   ...
   <!-- Left Panel -->
    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="content">
           ...
           <form:form method="post" action="/ResidentManagementSystem/gas/addBirth/${gas.gasId}" modelAttribute="birth">
							...
							<a href="/ResidentManagementSystem/gas/manageBirthList/${gas.gasId}" style="display:inline-block;color:white;float:left;"><i class="fa fa-angle-double-left" style="font-size:28px;" aria-hidden="true"></i></a><input type="Submit">
							</div>
				</form:form>
           </div>
            </div>
