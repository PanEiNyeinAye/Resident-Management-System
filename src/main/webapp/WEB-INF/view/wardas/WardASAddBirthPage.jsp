...
<head>
    ...
    <title>Ward/Village Administrators Manage Birth Registration</title>
                ...
                <div class="row">
                 <div class="card" style="left:190px;">
                  <div class="card-header" style="color:#fff; text-align:center;background-color:#3A4D6F;">
                               <strong>	Add Birth Registration </strong>
                            </div>
                            <div class="card-body card-block">
           <form:form method="post" action="/ResidentManagementSystem/wardas/addBirth/${wardAS.wardASId}" modelAttribute="birth">
           					<div class="row form-group">
		                    <div class="col col-md-3"><label for="text-input" class=" form-control-label">Place of Birth</label></div>
		                    <div class="col-12 col-md-9"><form:input path="placeOfBirth" id="text-input" name="text-input"  class="form-control" required="true"/><small class="form-text text-muted"></small></div>
		                	</div>
		                	
		                	<div class="row form-group">
		                    <div class="col col-md-3"><label for="text-input" class=" form-control-label">Date of Birth</label></div>
		                    <div class="col-12 col-md-9"><form:input path="dateOfBirth" id="text-input" name="text-input"  class="form-control" type="date" required="true"/><small class="form-text text-muted"></small></div>
		                	</div>
							...
							<form:radiobutton path="childGender" value="Male" id="inline-radio1" name="inline-radios" class="form-check-input" required="true"/>Male
							 </label>&nbsp;
							 <label for="inline-radio2" class="form-check-label ">
							<form:radiobutton path="childGender" value="Female" id="inline-radio2" name="inline-radios" class="form-check-input" required="true"/>Female<br>
							 </label>
							</div>
							</div>
                   			 </div>
		                    ...
		                    <div class="col-12 col-md-9"><form:input path="childFatherName" id="text-input" name="text-input"  class="form-control" required="true"/><small class="form-text text-muted">Please don't use U/Daw/Ko/Mg/Ma before the name!</small></div>
		                	</div>
		                	
		                	<div class="row form-group">
		                    <div class="col col-md-3"><label for="text-input" class=" form-control-label">Mother's Name</label></div>
		                    <div class="col-12 col-md-9"><form:input path="childMotherName" id="text-input" name="text-input"  class="form-control" required="true"/><small class="form-text text-muted">Please don't use U/Daw/Ko/Mg/Ma before the name!</small></div>
		                	</div>
		                	
		                	<div class="row form-group">
		                    <div class="col col-md-3"><label for="text-input" class=" form-control-label">Date of Registration</label></div>
		                    <div class="col-12 col-md-9"><form:input path="dateOfRegistration" id="text-input" name="text-input"  class="form-control" type="date" required="true"/><small class="form-text text-muted"></small></div>
		                	</div>
		                	
		      
							<div class="row form-group">
		                    <div class="col col-md-3"><label for="text-input" class=" form-control-label">Note</label></div>
		                    <div class="col-12 col-md-9"><form:input path="birthNote" id="text-input" name="text-input"  class="form-control" /><small class="form-text text-muted"></small></div>
		                	</div>
						
							<form:hidden path="wardOrVillageId" value="${wardAS.wardOrVillageId}"/><br>
		                	
							<div class="card-footer" style="background-color:#3A4D6F; color:black; text-align:center;">
							<a href="/ResidentManagementSystem/wardas/manageBirthList/${wardAS.wardASId}" style="display:inline-block;color:white;float:left;"><i class="fa fa-angle-double-left" style="font-size:28px;" aria-hidden="true"></i></a><input type="Submit">
							</div>
				</form:form>
           </div>
            </div>
