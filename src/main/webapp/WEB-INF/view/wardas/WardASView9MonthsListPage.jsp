        ...
        <div class="content">
            <div class="animated fadeIn">
                <div class="row">
                        ...
                        <div class="card" >
                           <div class="card-header" style="text-align:center; background-color:#3A4D6F; color:#fff;">
                                <strong class="card-title">9 Months Old Babies of (${wardAS.wardOrVillage.wardOrVillageName})</strong>
                            </div>
                            <div class="card-body">
                             <%@taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c"%>
               ...
               <thead>
                ...
                <tbody>
                 <c:forEach var="resident" items="${nineMonthsList}" varStatus="residentCount">
                    <tr>
