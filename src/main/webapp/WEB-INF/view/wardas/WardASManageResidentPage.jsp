                ...
                <div class="row">
                        ...
                        <div class="card" >
                            <div class="card-header" style="text-align:right; background-color:#3A4D6F; color:#fff;">
                            	<div style="text-align:center;position:relative;"><Strong>Residents of ${wardAS.wardOrVillage.wardOrVillageName}</Strong></div>
         						<a href="/ResidentManagementSystem/wardas/getAddResident/${wardAS.wardASId}" style="color:#fff"><i class="material-icons" style="color:#fff">&#xE147;</i> Add New Resident</a>
                            </div>
                            <div class="card-body">
                             <%@taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c"%>
                ...
                <tbody>
                 <c:forEach var="resident" items="${residentList}" varStatus="residentCount">
                    <tr>
						...
						<td>
                            <a href="/ResidentManagementSystem/wardas/getEditResident/${resident.residentId}/${wardAS.wardASId}" class="fa fa-pencil-square-o" aria-hidden="true"></a>
                        </td>				
					</tr>	
					 </c:forEach>				
                </tbody>
