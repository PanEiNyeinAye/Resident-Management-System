...
<head>
    ...
    <title>Ward/Village Administrators View Over 10 Non NRC Residents</title>
        ...
        <div class="content">
            <div class="animated fadeIn">
                <div class="row">
                        ...
                        <div class="card" >
                          <div class="card-header" style="text-align:center; background-color:#3A4D6F; color:#fff;">
                                <strong class="card-title">Residents 10 years or over 10 years old who lost NRC or have not registered yet (Female) (${wardAS.wardOrVillage.wardOrVillageName})</strong>
                            </div>
                            <div class="card-body">
                             <%@taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c"%>
               ...
               <thead>
                ...
                <tbody>
                 <c:forEach var="resident" items="${over10FemaleNonNrcList}" varStatus="residentCount">
                    <tr>
            ...
            <a href="/ResidentManagementSystem/wardas/viewOver10NonNRC/${wardAS.wardASId}" style="display:inline-block;color:#3A4D6F;float:left;"><i class="fa fa-angle-double-left" style="font-size:28px;" aria-hidden="true"></i></a>
                            </div>
                        </div>
                    </div>
