...
<head>
    ...
    <title>Ward/Village Administrators View Townships</title>
                      ...
                      <div class="col-md-12">
                        <div class="card" >
                            <div class="card-header" style="text-align:center; background-color:#3A4D6F; color:#fff;">
                                <strong class="card-title">Townships of Myanmar</strong>
                            </div>
                            <div class="card-body">
                             <%@taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c"%>
                                <table id="bootstrap-data-table" class="table table-striped table-bordered" style="text-align:center;">
									...
									<tbody>
									     ...
									     <c:forEach var="township" items="${townshipList}" varStatus="townshipCount">
										<tr>
										<td><c:out value ="${townshipCount.count}"/></td>
										<td><c:out value ="${township.townshipName}"/></td>
										<td><c:out value ="${township.stateOrRegion.stateOrRegionName}"/></td>
