        ...
        <div class="content" style="background-color:#3A4D6F;">
            ...
            <div class="animated fadeIn">
                <!-- Widgets  -->
                  ...
                  <div class="col-md-12">
                           <div class="card">
                           <div class="card-header" style="background-color:#f9dec0; font-size:18px;color:#3A4D6F; font-weight:bold; ">
                           Resident Movement
                           </div>
                           <div class="card-body">
                          	
                             <p style="color:#06213F; font-size:18px;">The resident of your ward <b>NRC Number ${receiver.sender.residentNrcNo} holder</b> has moved to our ward (${receiver.sender.wardAS.wardOrVillage.wardOrVillageName}, ${receiver.sender.wardAS.wardOrVillage.township.townshipName}) and want to change his/her current location. If this NRC holder is a valid resident of your ward, please confirm it.</p>
                       		<div class="card-footer" style="background-color:#f9dec0;">
                       		...
                       		<form:form action="/ResidentManagementSystem/wardas/confirm/${wardAS.wardASId}/${receiver.receiverId}" modelAttribute="confirm" method="post" style="display:inline-block;">
						         <input type="submit" value="Confirm">
						         <form:hidden path="confirm" value="1"/>
						      </form:form>
						    
						   
						      <form:form action="/ResidentManagementSystem/wardas/confirm/${wardAS.wardASId}/${receiver.receiverId}" modelAttribute="confirm" method="post" style="display:inline-block;">
						         <input type="submit" value="Cancel">
						         <form:hidden path="confirm" value="2"/>
						      </form:form>
						      </div>
						      </div>
                           </div> 
