                  ...
                  <div class="col-md-12">
                    <div class="card" >
                            <div class="card-header" style="text-align:center; background-color:#f9dec0; color:#06213F;">
                                <strong class="card-title">Messages Received</strong>
                            </div>
                            <div class="card-body">
                             <%@taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c"%>
                                <table id="bootstrap-data-table" class="table table-striped table-bordered" style="text-align:center;">
                                 <thead>
									...
									<tbody>
									     ...
									     <c:forEach var="nc" items="${notConfirmedList}" varStatus="ncCount">
										<tr>
										<td><c:out value ="${ncCount.count}"/></td>
										<td><c:out value ="${nc.sender.sentDate}"/></td>
										<td><c:out value ="${nc.sender.wardAS.wardOrVillage.wardOrVillageName}"/></td>
										<td>
                           					 <a href="/ResidentManagementSystem/wardas/receiveDetails/${wardAS.wardASId}/${nc.receiverId}" class="fa fa-eye" aria-hidden="true"></a>
                        				</td>	
										 </tr>
