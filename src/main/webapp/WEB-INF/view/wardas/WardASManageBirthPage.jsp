        ...
        <div class="content">
            ...
            <div class="animated fadeIn">
                ...
                <div class="row">
                     <div class="card">
                             <div class="card-header" style="text-align:right; background-color:#3A4D6F; color:#fff;">
                            	<div style="text-align:center;position:relative;"><Strong>Birth Certificate Registration (${wardAS.wardOrVillage.wardOrVillageName})</Strong></div>
         						<a href="/ResidentManagementSystem/wardas/getAddBirth/${wardAS.wardASId}" style="color:#fff"><i class="material-icons" style="color:#fff">&#xE147;</i> Add New Birth Certificate Registration</a>
                            </div>
                            <div class="card-body">
                             <%@taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c"%>
              ...
              <thead>
                ...
                <tbody>
                 <c:forEach var="baby" items="${birthList}" varStatus="babyCount">
                    <tr>
                    	<td><c:out value="${babyCount.count}"/></td>
                    	<td><c:out value ="${baby.placeOfBirth}"/></td>
						<td><c:out value ="${baby.dateOfBirth}"/></td>
						<td><c:out value ="${baby.childGender}"/></td>
						<td><c:out value ="${baby.childFatherName}"/></td>
						<td><c:out value ="${baby.childMotherName}"/></td>
						<td><c:out value ="${baby.dateOfRegistration}"/></td>
						<td><c:out value ="${baby.birthNote}"/></td>
						<td><c:out value="${baby.wardOrVillage.wardOrVillageName}"/></td>	
						<td>
                            <a href="/ResidentManagementSystem/wardas/getEditBirth/${baby.birthId}/${wardAS.wardASId}" class="fa fa-pencil-square-o" aria-hidden="true"></a>
                        </td>	
					</tr>	
					 </c:forEach>				
                </tbody>
