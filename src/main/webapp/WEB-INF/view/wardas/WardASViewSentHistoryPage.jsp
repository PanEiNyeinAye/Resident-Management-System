        ...
        <div class="content" style="background-color:#3A4D6F;">
            ...
            <div class="animated fadeIn">
                <!-- Widgets  -->
                  ...
                  <div class="col-md-12">
                    <div class="card" >
                            <div class="card-header" style="text-align:center; background-color:#f9dec0; color:#06213F;">
                                <strong class="card-title">Messages Sent</strong>
                            </div>
                            <div class="card-body">
                             <%@taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c"%>
                                <table id="bootstrap-data-table" class="table table-striped table-bordered" style="text-align:center;">
									...
									<tbody>
									     ...
									     <c:forEach var="sh" items="${sentHistory}" varStatus="shCount">
										<tr>
										<td><c:out value ="${shCount.count}"/></td>
										<td><c:out value ="${sh.sender.sentDate}"/></td>
										<td><c:out value ="${sh.sender.residentNrcNo}"/></td>
										<td><c:out value ="${sh.sender.wardAS.wardOrVillage.wardOrVillageName}"/></td>
										<c:if test="${sh.confirm eq 1}">
										<td><c:out value ="Confirmed"/></td>
										</c:if>
										<c:if test="${sh.confirm eq 2}">
										<td><c:out value ="Canceled"/></td>
										</c:if>
										<c:if test="${sh.confirm eq 3}">
										<td><c:out value ="Not Check Yet"/></td>
										</c:if>	
										 </tr>
                                ...
                                <a href="/ResidentManagementSystem/wardas/getSend/${wardAS.wardASId}" style="display:inline-block;color:#3A4D6F;float:left;"><i class="fa fa-angle-double-left" style="font-size:28px;" aria-hidden="true"></i></a>
                            </div>
                        </div>
