        ...
        <div class="content">
            <div class="animated fadeIn">
                <div class="row">
                        ...
                        <div class="card" >
                             <div class="card-header" style="text-align:right; background-color:#3A4D6F; color:#fff;">
                            	<div style="text-align:center;position:relative;"><Strong>Police Officers of Myanmar</Strong></div>
         						<a href="/ResidentManagementSystem/admin/getAddPoliceOfficer" style="color:#fff"><i class="material-icons" style="color:#fff">&#xE147;</i> Add New Police Officer</a>
                            </div>
                            <div class="card-body">
                             <%@taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c"%>
               ...
               <thead>
                ...
                <tbody>
                 <c:forEach var="p" items="${policeOfficerListByAdmin}" varStatus="pCount">
                    <tr>
                    	<td><c:out value ="${pCount.count}"/></td>
                    	<td><c:out value ="${p.policeOfficerName}"/></td>
						<td><c:out value ="${p.policeEmployeeNo}"/></td>
						<td><c:out value ="${p.policeOfficerPosition}"/></td>
						<td><c:out value ="${p.policeOfficerEmail}"/></td>
						<td><c:out value ="${p.policeOfficerPassword}"/></td>
						<td><c:out value ="${p.township.townshipName}"/></td>
						<td>
                            <a href="/ResidentManagementSystem/admin/getEditPoliceOfficer/${p.policeOfficerId}" class="fa fa-pencil-square-o" aria-hidden="true"></a>
                        </td>				
					</tr>	
					 </c:forEach>				
                </tbody>
