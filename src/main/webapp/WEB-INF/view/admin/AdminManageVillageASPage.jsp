    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="content">
            ...
            <div class="animated fadeIn">
                   ...
                   <div class="col-md-12">
                        <div class="card" >
                        	<div class="card-header" style="text-align:right; background-color:#3A4D6F; color:#fff;">
                            	<div style="text-align:center;position:relative;"><Strong>Village Administrators of Myanmar</Strong></div>
         						<a href="/ResidentManagementSystem/admin/getAddVillageAS" style="color:#fff"><i class="material-icons" style="color:#fff">&#xE147;</i> Add New Village Administrator</a>
                            </div>
                ...
                <tbody>
                 <c:forEach var="wardas" items="${villageASListByAdmin}" varStatus="wardasCount">
                    <tr>
						...
						<td>
                            <a href="/ResidentManagementSystem/admin/getEditVillageAS/${wardas.wardASId}" class="fa fa-pencil-square-o" aria-hidden="true"></a>
                        </td>			
					</tr>	
					 </c:forEach>				
                </tbody>
