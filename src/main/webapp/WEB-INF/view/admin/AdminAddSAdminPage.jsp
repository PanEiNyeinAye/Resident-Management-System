   ...
   <aside id="left-panel" class="left-panel">
    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="content">
           ...
           <form:form method="post" action="/ResidentManagementSystem/admin/addSAdmin" modelAttribute="sadmin">
           					<div class="row form-group">
		                    <div class="col col-md-3"><label for="text-input" class=" form-control-label">Name</label></div>
		                    <div class="col-12 col-md-9"><form:input path="sadminName" id="text-input" name="text-input"  class="form-control" required="true"/><small class="form-text text-muted">Please use U/Daw before the name!</small></div>
		                	</div>
	
							<div class="row form-group">
		                    <div class="col col-md-3"><label for="text-input" class=" form-control-label">Employee No.</label></div>
		                    <div class="col-12 col-md-9"><form:input path="sadminEmployeeNo" id="text-input" name="text-input"  class="form-control" placeholder="" required="true"/><small class="form-text text-muted"></small></div>
		                	</div>
							
							<div class="row form-group">
							<div class="col col-md-3"><label for="email-input" class=" form-control-label">Email</label></div>
							<div class="col-12 col-md-9"><form:input path="sadminEmail" placeholder="Enter Email" id="email-input" name="email-input" class="form-control" required="true"/><small class="help-block form-text">Please enter your email</small></div><br>
							<div class="col-12 col-md-9 error"><c:if test="${error eq true}">* Email must be in correct format.</c:if></div>
							</div>
							
							<div class="row form-group">
		                    <div class="col col-md-3"><label for="text-input" class=" form-control-label">Password</label></div>
		                    <div class="col-12 col-md-9"><form:password path="sadminPassword" id="text-input" name="text-input"  class="form-control" required="true"/><small class="form-text text-muted"></small></div>
		                	<div class="col-12 col-md-9 error"><c:if test="${error eq true}">* Password must have 8 characters.</c:if></div>
		                	</div>
							
							<div class="row form-group">
		                    <div class="col col-md-3"><label for="text-input" class=" form-control-label">State or Region Id</label></div>
		                    <div class="col-12 col-md-9">
			                    <form:select path="stateOrRegionId"  name="select" id="select" class="form-control">
			                    	<form:options items="${stateOrRegionList}" itemValue="stateOrRegionId" itemLabel="stateOrRegionName"/>    	
			                    </form:select>
			                    </div>
		                	</div>
							...
							<a href="/ResidentManagementSystem/admin/manageSAdminList" style="display:inline-block;color:white;float:left;"><i class="fa fa-angle-double-left" style="font-size:28px;" aria-hidden="true"></i></a><input type="Submit">
							</div>
				</form:form>
           </div>
            </div>
