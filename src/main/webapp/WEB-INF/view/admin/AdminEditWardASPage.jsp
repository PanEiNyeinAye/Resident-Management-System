...
<head>
    ...
    <title>Admin Manages Ward Administrators</title>
            ...
            <div class="animated fadeIn">
               ...
               <div class="card" style="left:190px;">
                            <div class="card-header" style="color:#fff; text-align:center;background-color:#3A4D6F;">
                               <strong>	Edit Ward Administrator </strong>
                            </div>
                            <div class="card-body card-block">
           <form:form method="post" action="/ResidentManagementSystem/admin/editWardAS">
           
           					<form:hidden path="wardASId"/>
           					
           					<div class="row form-group">
		                    <div class="col col-md-3"><label for="text-input" class=" form-control-label">Name</label></div>
		                    <div class="col-12 col-md-9"><form:input path="wardASName" id="text-input" name="text-input"  class="form-control" required="true"/><small class="form-text text-muted"></small></div>
		                	</div>
							...
							<form:hidden path="wardASPosition" value="Ward Administrator"/>
							
							<div class="row form-group">
							<div class="col col-md-3"><label for="email-input" class=" form-control-label">Email</label></div>
							<div class="col-12 col-md-9"><form:input path="wardASEmail" placeholder="Enter Email" id="email-input" name="email-input" class="form-control" required="true"/><small class="help-block form-text"></small></div><br>
							...
							<div class="col-12 col-md-9"><form:input path="wardASPhoneNo"  id="text-input" name="text-input"  class="form-control" required="true"/><small class="help-block form-text"></small></div><br>
								...
								<div class="row form-group">
		                    <div class="col col-md-3"><label for="text-input" class=" form-control-label">Ward Name</label></div>
		                    <div class="col-12 col-md-9">
			                    <form:select path="wardOrVillageId"  name="select" id="select" class="form-control">
			                    	<form:options items="${wardList}" itemValue="wardOrVillageId" itemLabel="wardOrVillageName"/>    	   	
			                    </form:select>
			                    </div>
		                	</div>
							...
							<a href="/ResidentManagementSystem/admin/manageWardASList" style="display:inline-block;color:white;float:left;"><i class="fa fa-angle-double-left" style="font-size:28px;" aria-hidden="true"></i></a><input type="Submit">
							</div>
				</form:form>
           </div>
            </div>
