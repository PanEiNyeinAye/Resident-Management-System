...
<head>
    ...
    <title>Admin Manages Police Officer</title>
 ...
 <aside id="left-panel" class="left-panel">
    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="content">
           ...
           <form:form method="post" action="/ResidentManagementSystem/admin/addPoliceOfficer" modelAttribute="policeOfficer">
		                    ...
		                    <div class="col-12 col-md-9">
			                    <form:select path="townshipId"  name="select" id="select" class="form-control">
			                    	<form:options items="${townshipList}" itemValue="townshipId" itemLabel="townshipName"/>    	
			                    </form:select>
			                    </div>
		                	</div>
							...
							<a href="/ResidentManagementSystem/admin/managePoliceOfficerList" style="display:inline-block;color:white;float:left;"><i class="fa fa-angle-double-left" style="font-size:28px;" aria-hidden="true"></i></a><input type="Submit">
							</div>
				</form:form>
           </div>
            </div>
