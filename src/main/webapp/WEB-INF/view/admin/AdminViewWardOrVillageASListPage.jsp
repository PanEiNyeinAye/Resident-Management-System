...
<head>
    ...
    <title>Admin Views Ward/Village Administrators</title>
    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="content">
            ...
            <div class="animated fadeIn">
                   ...
                   <div class="col-md-12">
                        <div class="card" >
                            <div class="card-header" style="text-align:center; background-color:#3A4D6F; color:#fff;">
                                <strong class="card-title">Ward/Village Administrators of Myanmar</strong>
                            </div>
                            <div class="card-body">
                             <%@taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c"%>
                ...
                <tbody>
                 <c:forEach var="wardas" items="${wardOrVillageASListByAdmin}" varStatus="wardasCount">
                    <tr>
