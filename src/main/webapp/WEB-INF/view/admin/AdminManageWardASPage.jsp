    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="content">
            ...
            <div class="animated fadeIn">
                   ...
                   <div class="col-md-12">
                        <div class="card" >
                            <div class="card-header" style="text-align:right; background-color:#3A4D6F; color:#fff;">
                            	<div style="text-align:center;position:relative;"><Strong>Ward Administrators of Myanmar</Strong></div>
         						<a href="/ResidentManagementSystem/admin/getAddWardAS" style="color:#fff"><i class="material-icons" style="color:#fff">&#xE147;</i> Add New Ward Administrator</a>
                            </div>
                            <div class="card-body">
                             <%@taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c"%>
                ...
                <tbody>
                 <c:forEach var="wardas" items="${wardASListByAdmin}" varStatus="wardasCount">
                    <tr>
						...
						<td>
                            <a href="/ResidentManagementSystem/admin/getEditWardAS/${wardas.wardASId}" class="fa fa-pencil-square-o" aria-hidden="true"></a>
                        </td>			
					</tr>	
					 </c:forEach>				
                </tbody>
