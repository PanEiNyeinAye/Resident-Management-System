...
<head>
    ...
    <title>Admin Manages Death Registration</title>
        ...
        <div class="content">
            ...
            <div class="animated fadeIn">
               ...
               <div class="card" style="left:190px;">
                            <div class="card-header" style="background-color:#3A4D6F;color:#fff; text-align:center;">
                               <strong>	Add Death Registration </strong>
                            </div>
                            <div class="card-body card-block">
           <form:form method="post" action="/ResidentManagementSystem/admin/addDeath" modelAttribute="death">
							...
							<a href="/ResidentManagementSystem/admin/manageDeathList" style="display:inline-block;color:white;float:left;"><i class="fa fa-angle-double-left" style="font-size:28px;" aria-hidden="true"></i></a><input type="Submit">
							</div>
				</form:form>
           </div>
            </div>
